...
export default function ContactSection() {
    ...
    return (
        <section
            id="contact"
            ref={sectionRef}
            className="min-h-screen flex flex-col justify-center px-4 lg:px-8 py-24 max-w-6xl mx-auto"
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <address className="space-y-4 not-italic">
                        ...
                        <div className="flex items-center gap-4 mt-2">
                            ...
                            <nav aria-label="Social media" className="flex gap-3">
                                <a href={social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Visit my Instagram profile" className="w-10 h-10 rounded-xl bg-card border border-border flex items-center justify-center hover:border-lime hover:bg-lime/10 transition-all text-muted-foreground hover:text-foreground">
                                ...
                                <a href={social.tiktok} target="_blank" rel="noopener noreferrer" aria-label="Visit my TikTok profile" className="w-10 h-10 rounded-xl bg-card border border-border flex items-center justify-center hover:border-lime hover:bg-lime/10 transition-all text-muted-foreground hover:text-foreground">
                                ...
                                <a href={social.github} target="_blank" rel="noopener noreferrer" aria-label="Visit my GitHub profile" className="w-10 h-10 rounded-xl bg-card border border-border flex items-center justify-center hover:border-lime hover:bg-lime/10 transition-all text-muted-foreground hover:text-foreground">
                                ...
                                <a href={social.linkedin} target="_blank" rel="noopener noreferrer" aria-label="Visit my LinkedIn profile" className="w-10 h-10 rounded-xl bg-card border border-border flex items-center justify-center hover:border-lime hover:bg-lime/10 transition-all text-muted-foreground hover:text-foreground">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 contact-form" data-captcha="turnstile">
                    ...
                    <div>
                        <label htmlFor="email-input" className="text-sm font-semibold tracking-wider uppercase text-muted-foreground mb-2 block">
                            Email
                        </label>
                        <Input
                            id="email-input"
                    ...
                    <div>
                        <label htmlFor="message-input" className="text-sm font-semibold tracking-wider uppercase text-muted-foreground mb-2 block">
                            Message
                        </label>
                        <Textarea
                            id="message-input"
