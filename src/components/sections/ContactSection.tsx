                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4 mt-2">
                            ...
                            <div className="flex gap-3">
                                <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="Visit my Instagram profile" className="w-10 h-10 rounded-xl bg-card border border-border flex items-center justify-center hover:border-[#CEF441] hover:bg-[#CEF441]/10 transition-all text-muted-foreground hover:text-foreground">
                                ...
                                <a href="https://tiktok.com/" target="_blank" rel="noopener noreferrer" aria-label="Visit my TikTok profile" className="w-10 h-10 rounded-xl bg-card border border-border flex items-center justify-center hover:border-[#CEF441] hover:bg-[#CEF441]/10 transition-all text-muted-foreground hover:text-foreground">
                                ...
                                <a href="https://github.com/" target="_blank" rel="noopener noreferrer" aria-label="Visit my GitHub profile" className="w-10 h-10 rounded-xl bg-card border border-border flex items-center justify-center hover:border-[#CEF441] hover:bg-[#CEF441]/10 transition-all text-muted-foreground hover:text-foreground">
                                ...
                                <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" aria-label="Visit my LinkedIn profile" className="w-10 h-10 rounded-xl bg-card border border-border flex items-center justify-center hover:border-[#CEF441] hover:bg-[#CEF441]/10 transition-all text-muted-foreground hover:text-foreground">
