                ...
                <div className="projects-horizontal-track flex">
                    ...
                    <div className="projects-panel w-screen h-screen shrink-0 flex flex-col justify-center px-4 md:px-8">
                        <div className="max-w-5xl mx-auto w-full">
                            ...
                            <p className="text-base md:text-xl leading-relaxed text-muted-foreground max-w-xl">
                    ...
                    {displayedProjects.map((project, i) => (
                        <article
                            key={project.index}
                            className="projects-panel w-screen h-screen shrink-0 flex flex-col justify-center px-4 md:px-8"
                        >
                            <div className="max-w-5xl mx-auto w-full">
                                ...
                                <div className="flex flex-col md:flex-row items-start gap-4 md:gap-8 relative">
                                    <span className="project-bg-number text-[clamp(6rem,15vw,14rem)] font-black text-lime/10 md:text-lime/20 leading-none select-none absolute md:static -top-16 right-0 md:-top-0 lg:opacity-100 opacity-30">
                                        {String(i + 1).padStart(2, "0")}
                                    </span>

                                    <div className="flex-1 pt-4 relative z-10">
                                        <h2 className="text-[clamp(2.5rem,6vw,5rem)] font-black leading-[0.9] tracking-[-0.03em] mb-4 md:mb-6">
                                            {project.title}
                                        </h2>
                                        <p className="text-base md:text-xl leading-relaxed text-muted-foreground mb-6 md:mb-8 max-w-2xl">
                                            {project.description}
                                        </p>
                    ...
                    <div className="projects-panel w-screen h-screen shrink-0 flex flex-col items-center justify-center px-4 md:px-8">
                        <div className="text-center">
                            ...
                            <p className="text-base md:text-xl text-muted-foreground mb-10 max-w-lg mx-auto">
